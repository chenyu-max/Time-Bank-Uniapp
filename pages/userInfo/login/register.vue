		...
		<uni-forms class="form" ref="form" :modelValue="formData">
			<view class="">
				...
				<uni-forms-item label="身份" name="identity">
					<radio-group name="identity" @change="radioChange">
						<label>
							<radio value="家长" /><text>家长</text>
						</label>
						<label style="margin-left: 30px;">
							<radio value="家教" /><text>家教</text>
						</label>
					</radio-group>
				</uni-forms-item>
			</view>
			<button class="login-btn" @click="_userRegisterSubmit">立即注册</button>
		</uni-forms>
	</view>
</template>
